...
# Implemment MaxStack based off Stack class
...
class MaxStack
  ...
  # Remove and return the top item from our stack. If it equals the top item in maxs_stack, they must have been pushed in together. So we'll pop it out of maxs_stack too.
  def pop(item)
    item = @stack.pop()
